...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/listforuser.css">
</head>
<body>
<div class="container">
    ...
    <div class="content">
        <%
            User cliente = (User) request.getAttribute("client");
            if (cliente == null) {
        %>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <p class="paragraph"><span class="bold">Data:</span> <%= new SimpleDateFormat("dd/MM/yyyy - HH:mm", Locale.ITALIAN).format(order.getDateOrder()) %></p>
        ...
        <div class="pagination">
            <% if (skip > 0) { %>
            <form action="${pageContext.request.contextPath}/admin/listordersemail" method="get">
